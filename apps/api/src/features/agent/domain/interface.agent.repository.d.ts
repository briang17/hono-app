...
export interface IAgentRepository {
    ...
    delete(id: Id, organizationId: Id, tx?: Transaction<import("drizzle-orm/pg-core").PgTransaction<"readwrite">>): Promise<void>;
    deleteInvitationForAgent(organizationId: Id, email: string, tx?: Transaction<import("drizzle-orm/pg-core").PgTransaction<"readwrite">>): Promise<void>;
    deleteMemberForAgent(organizationId: Id, userId: Id | null, tx?: Transaction<import("drizzle-orm/pg-core").PgTransaction<"readwrite">>): Promise<void>;
