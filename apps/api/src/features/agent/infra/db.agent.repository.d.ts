...
import { type Agent, type AgentWithUser, type UpdateAgentInput } from "../domain/agent.entity";
...
export declare class DbAgentRepository implements IAgentRepository {
    ...
    delete(id: Id, organizationId: Id, tx?: Transaction<PgTransaction<"readwrite">>): Promise<void>;
    deleteInvitationForAgent(organizationId: Id, email: string, tx?: Transaction<PgTransaction<"readwrite">>): Promise<void>;
    deleteMemberForAgent(organizationId: Id, userId: Id | null, tx?: Transaction<PgTransaction<"readwrite">>): Promise<void>;
