declare const openhouseRoutes: import("hono/hono-base").HonoBase<import("../../../lib/types").HonoEnv & {
    Variables: {
        user: {
            id: string;
            createdAt: Date;
...
declare const publicOpenHouseRoutes: import("hono/hono-base").HonoBase<import("hono/types").BlankEnv, {
    "/:id": {
        $get: {
            input: {
                param: {
