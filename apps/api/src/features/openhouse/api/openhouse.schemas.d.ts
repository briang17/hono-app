import { type NewOpenHouseLeadSchema, type NewOpenHouseSchema } from "@openhouse/domain/openhouse.entity";
import { z } from "zod";
...
export type CreateOpenHouseLeadParams = z.infer<typeof CreateOpenHouseLeadParamsSchema>;
